...
router.patch('/updateCenterProviderExpiredDate/:centerProviderId', auth(roles.Center) ,fileUpload(fileValidation.image).single('image'),validation(validators.updateCenterProvider), asyncHandler(AdvertisementController.updateCenterProviderExpiredDate));
...
router.patch('/restore/:advertisementId', auth(endPoint.delete), validation(validators.getSpecificAdvertisement), asyncHandler(AdvertisementController.restoreAdvertisement));
router.patch('/softDelete/:advertisementId', auth(endPoint.delete), validation(validators.getSpecificAdvertisement), asyncHandler(AdvertisementController.softDeleteAdvertisement));
router.delete('/hardDelete/:advertisementId', auth(endPoint.delete), validation(validators.getSpecificAdvertisement), asyncHandler(AdvertisementController.hardDeleteAdvertisement));
